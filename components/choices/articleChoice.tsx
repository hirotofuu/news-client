        ...
        <div className="group hover:bg-gray-100 flex p-3 border-b bg-white"  key={kiji.id}>
          ...
          <div className="ml-4">
            ...
            <div className="flex gap-4 mt-3 font-thin">
              ...
              <h2 className="font-normal text-gray-500 text-sm"><FontAwesomeIcon icon={faEye} className="mr-1"></FontAwesomeIcon>{kiji.view_number}</h2>
              <h2 className="font-normal text-gray-500 text-sm"><FontAwesomeIcon icon={faCalendarDays} className="mr-1"></FontAwesomeIcon>{kiji.day_time}</h2>
