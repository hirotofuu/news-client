  ...
  return(
    <>
      <section className="w-full  p-2 pt-4  bg-white">
        {article.image_file ? <Image alt="article image" src={`https://s3.ap-northeast-1.amazonaws.com/newbyte-s3/${article.image_file}`} className="" objectFit="cover"   width={800}  height={475} /> : ''}
